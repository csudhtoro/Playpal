...
function MapBox({ location }) {
  ...
  return (
    <div className="max-w-[700px] object-cover rounded-md overflow-hidden mx-auto w-[70%] h-1/5 sm:h-1/4 md:w-[90%] lg:w-3/5 border-[0.1rem]  border-slate-500 shadow-md shadow-slate-400">
      <Map
        ref={mapRef}
